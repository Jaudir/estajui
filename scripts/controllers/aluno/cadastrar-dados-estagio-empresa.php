...
//if($session->isAluno()){
    ...
    if(isset($_POST["cadastrar"]) && isset($_POST["estagio_id"])){//adicionar condição de restrição e de dono
        ...
        $supervisor = new Supervisor(null,$_POST["nome"], $_POST["cargo"], $_POST["habilitação"], null);
        $model = $loader->loadModel('EstagioModel','EstagioModel');
         if($model->cadastrarDadosEstagio($supervisor, $endereco, $planoDeEstagio,$empresa, isset($_POST['novaEmpresa']))){
