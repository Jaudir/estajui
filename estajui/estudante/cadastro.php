      ...
      <nav class="navbar navbar-expand-lg navbar-light nav-menu">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="nav-content navbar-nav">
            <li class="nav-item">
              <a href="../login/login.php"><button type="button" class="btn btn-outline-light bt-sair">Voltar</button></a>
            </li>
          </ul>
        </div>
      </nav>
            ...
            <section>
              <div class="row">
                ...
                <div class="col-md-6 mb-3">
                  ...
                  <input value="<?php if(!empty($_SESSION['cpf'])) echo  htmlspecialchars($_SESSION['cpf']);
                  unset($_SESSION['cpf']); ?>" type="text" class="form-control" id="cpf" name="cpf"
              ...
              <div class="row">
                  <div class="col-md-6 mb-3">
                    ...
                    <input value="<?php if(!empty($_SESSION['rg'])) echo  htmlspecialchars($_SESSION['rg']);
                    unset($_SESSION['rg']);?>"  name="rg" type="number" class="form-control"
                    id="rg" placeholder="Apenas o número" required>
                    <div class="invalid-feedback">
              ...
              <div class="row">
                ...
                <div class="col-md-2 mb-2">
                  ...
                  <input value="<?php if(!empty($_SESSION['cep'])) echo
                  htmlspecialchars($_SESSION['cep']); unset($_SESSION['cep']); ?>"
                   name="cep" type="text" class="form-control" name="cep" id="cep" placeholder="99999-999" required>
                  <div class="invalid-feedback">
