          ...
          <form class="container" id="needs-validation" novalidate method="POST" action="<?php echo base_url()?>/scripts/controllers/persiste_alteracao.php">
            <div class="row">
              <div class="col-md-6 mb-3">
                ...
                <input name="nome" value="<?php echo htmlspecialchars($usuario->getnome()); ?>" type="text" class="form-control" id="validationCustom01" placeholder="<?php echo $usuario->getnome(); ?>" >
              ...
              <div class="col-md-6 mb-3">
                ...
                <input type="text" class="form-control" id="validationCustom02" placeholder="<?php echo $usuario->getcpf(); ?>"  required>
              </div>
            </div>
            <div class="row">
                <div class="col-md-6 mb-3">
                  <label for="validationCustom03">Nº de identidade</label>
                  <input type="text" class="form-control" id="validationCustom03" placeholder="<?php echo $usuario->getrg_num(); ?>"  required>
                </div>
                <div class="col-md-6 mb-2">
                  <label for="validationCustom04">Orgão expedidor</label>
                  <input name="orgao_exp" value="<?php echo  htmlspecialchars($usuario->getrg_orgao()); ?>" type="text" class="form-control" id="validationCustom04" placeholder="<?php echo $usuario->getrg_orgao(); ?>" >
                  <div class="invalid-feedback">
            ...
            <div class="row">
              <div class="col-md-6 mb-3">
                ...
                <input name="cidade_natal" value="<?php echo htmlspecialchars($usuario->getcidade_natal());?>" type="text" class="form-control" id="validationCustom05" placeholder="<?php echo $usuario->getcidade_natal(); ?>" >
                <div class="invalid-feedback">
            ...
            <div class="row">
              <div class="col-md-4 mb-3">
                ...
                <input type="text" class="form-control" id="validationCustom06" placeholder="<?php echo (new DateTime($usuario->getdata_nasc()))->format('d-m-Y'); ?>" >
              </div>
            ...
            <div class="row">
              <div class="col-md-6 mb-3">
                ...
                <input name="nome_mae" value="<?php echo  htmlspecialchars($usuario->getnome_mae());?>" type="text" class="form-control" id="validationCustom09" placeholder="<?php echo $usuario->getnome_mae(); ?>" >
                <div class="invalid-feedback">
              ...
              <div class="col-md-6 mb-2">
                ...
                <input name="nome_pai" value="<?php htmlspecialchars($usuario->getnome_pai());?>" type="text" class="form-control" id="validationCustom03" placeholder="<?php echo $usuario->getnome_pai(); ?>" >
                <div class="invalid-feedback">
                  Por favor, informe um nome.
                </div>
              </div>
            ...
            <div class="row">
              <div class="col-md-4 mb-3">
                ...
                <input name="logradouro" value="<?php echo  htmlspecialchars($endereco->getlogradouro());?>" type="text" class="form-control" id="validationCustom11" placeholder="<?php echo $usuario->getendereco()->getlogradouro(); ?>" >
                <div class="invalid-feedback">
                  Preencha este campo.
                </div>
              </div>
              <div class="col-md-4 mb-2">
                ...
                <input name="bairro" value="<?php echo  htmlspecialchars($endereco->getbairro());?>" type="text" class="form-control" id="validationCustom12" placeholder="<?php echo $usuario->getendereco()->getbairro(); ?>" >
                <div class="invalid-feedback">
                  Preencha este campo.
                </div>
              </div>
              <div class="col-md-2 mb-2">
                ...
                <input name="numero" value="<?php echo  htmlspecialchars($endereco->getnumero());?>" type="text" class="form-control" id="validationCustom13" placeholder="<?php echo $usuario->getendereco()->getnumero(); ?>" >
                <div class="invalid-feedback">
                  Preencha este campo.
                </div>
              </div>
              <div class="col-md-2 mb-2">
                ...
                <input name="cep" value="<?php echo  htmlspecialchars($endereco->getcep());?>" type="text" class="form-control" id="validationCustom14" placeholder="<?php echo $usuario->getendereco()->getcep(); ?>" >
                <div class="invalid-feedback">
            ...
            <div class="row">
              <div class="col-md-4 mb-3">
                ...
                <input value="<?php echo  htmlspecialchars($endereco->getcomplemento());?>" type="text" class="form-control" id="validationCustom15" placeholder="<?php echo $usuario->getendereco()->getlogradouro(); ?>">
              </div>
              <div class="col-md-4 mb-2">
                <label for="validationCustom16">Cidade</label>
                <input name="cidade" value="<?php echo  htmlspecialchars($endereco->getcidade());?>" type="text" class="form-control" id="validationCustom16" placeholder="<?php echo $usuario->getendereco()->getcidade(); ?>" >
                <div class="invalid-feedback">
                  Preencha este campo.
                </div>
              </div>
            ...
            <div class="row">
              <div class="col-md-6 mb-3">
                ...
                <input name="celular" value="<?php echo  htmlspecialchars($usuario->getcelular());?>" type="text" class="form-control" id="validationCustom18" placeholder="<?php echo $usuario->getcelular(); ?>" >
                <div class="invalid-feedback">
                  Preencha este campo.
                </div>
              </div>
              <div class="col-md-6 mb-2">
                ...
                <input value="<?php echo  htmlspecialchars($usuario->gettelefone());?>" type="text" class="form-control" id="validationCustom19" placeholder="<?php echo $usuario->gettelefone(); ?>">
              </div>
            </div>
            <div class="row">
              <div class="col-md-6 mb-3">
