                            ...
                            <table class="table table-bordered">
                                ...
                                <tbody>
                                    ...
                                    foreach ($listaDeEstagios as $le):
                                        if ($le->getstatus()->getcodigo() == 4  || ($le->getstatus()->getcodigo() == 3 && $le->getempresa()->getconveniada() == 0) || $le->getstatus()->getcodigo() == 1 ) {
                                            ?>
                                            <tr class="">
                                                ...
                                                <td class="center">
                                                    <button type="button" class="btn btn-link empresaModalToggle"
                                                            ...
                                                            } else if ($le->getstatus()->getcodigo() == 3 && $le->getempresa()->getconveniada() == 0) {
