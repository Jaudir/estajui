                                        ...
                                        <tbody>
                                            ...
                                            foreach ($estagios as &$estagio):
                                                ...
                                                <tr class="red">
                                                    ...
                                                    <td class="center">
                                                        <button type="button" class="btn btn-link" data-toggle="modal" data-target="#detalhes<?php echo $estagio->getestagio()->getid(); ?>">
                                                            <i class="fa fa-eye"></i>
                                                        </button>
                                                    </td>
                                                </tr>
                                                <!-- MODAL para mostrar detalhes do estágio -->
                                            <div class="modal fade" id="detalhes<?php echo $estagio->getestagio()->getid(); ?>" tabindex="-1" role="dialog" aria-labelledby="detalhesEstagioTitle" aria-hidden="true">
                                                <div class="modal-dialog modal-lg" role="document">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h5 class="modal-title" id="detalhesEstagioTitle">Detalhes do estágio</h5>
                                                        ...
                                                        <div class="modal-body">
                                                            <div class="row">
                                                                <div class="col-md-12 dados-aluno">
                                                                    <a target="_blank" href="./pe/pe.php?estagio_id=<?php echo $estagio->getestagio()->getid(); ?>" class="btn btn-primary"><span class="glyphicon glyphicon-print"></span>Plano de Estagio</a>
                                                                    <a target="_blank" href="./tc/tc.php?estagio_id=<?php echo $estagio->getestagio()->getid(); ?>" class="btn btn-primary"><span class="glyphicon glyphicon-print"></span>Termo de Compromisso</a>
                                                                    <br>
                                                                    <br>
                                                                    <h6>Status: </h6> <p><?php echo $estagio->getestagio()->getstatus()->getdescricao(); ?></p><br>
                                                                    <h6>Nº da apólice seguradora: </h6> <p><?php echo ($estagio->getestagio()->getapolice()) ? $estagio->getestagio()->getapolice()->getnumero() : NULL; ?></p><br>
                                                                    <h6>Setor/Unidade da empresa: </h6> <p><?php echo ($estagio->getestagio()->getpe()) ? $estagio->getestagio()->getpe()->getsetor_unidade() : NULL; ?></p> <br>
                                                                    <h6>Supervisor: </h6> <p><?php echo (!$estagio->getestagio()->getsupervisor()) ? NULL : $estagio->getestagio()->getsupervisor()->getnome(); ?></p> <br>
                                                                    <h6>Habilitação profissional: </h6> <p><?php echo (!$estagio->getestagio()->getsupervisor()) ? NULL : $estagio->getestagio()->getsupervisor()->gethabilitacao(); ?></p> <br>
                                                                    <h6>Cargo: </h6> <p><?php echo (!$estagio->getestagio()->getsupervisor()) ? NULL : $estagio->getestagio()->getsupervisor()->getcargo(); ?></p> <br>
                                                                    <h6>Professor orientador: </h6> <p><?php echo ($estagio->getestagio()->getfuncionario()) ? $estagio->getestagio()->getfuncionario()->getnome() : NULL; ?></p> <br>
                                                                    <h6>Formação profissional: </h6> <p><?php echo ($estagio->getestagio()->getfuncionario()) ? $estagio->getestagio()->getfuncionario()->getformacao() : NULL; ?></p> <br>
                                                                    <h6>Data prevista para ínicio do estágio: </h6> <p><?php echo ($estagio->getestagio()->getpe()) ? $estagio->getestagio()->getpe()->getdata_inicio() : NULL; ?></p> <br>
                                                                    <h6>Data prevista para término do estágio: </h6> <p><?php echo ($estagio->getestagio()->getpe()) ? $estagio->getestagio()->getpe()->getdata_fim() : NULL; ?></p> <br>
                                                                    <h6>Jornada: </h6> <p><?php echo ($estagio->getestagio()->getpe()) ? $estagio->getestagio()->getpe()->gethora_inicio1() . "h às " . $estagio->getestagio()->getpe()->gethora_fim1() . "h, totalizando " . $estagio->getestagio()->getpe()->gettotal_horas() . "h semanais." : NULL ?></p> <br>
                                                                    <h6>Principais atividdes a serem desenvolvidas: </h6>
                                                                    <p><?php echo ($estagio->getestagio()->getpe()) ? $estagio->getestagio()->getpe()->getatividades() : NULL; ?></p> <br>
                                                                    <h6>Nome fantasia da empresa: </h6> <p><?php echo (!$estagio->getestagio()->getempresa()) ? NULL : $estagio->getestagio()->getempresa()->getnome(); ?></p> <br>
                                                                    <h6>Razão social da empresa: </h6> <p><?php echo (!$estagio->getestagio()->getempresa()) ? NULL : $estagio->getestagio()->getempresa()->getrazaosocial(); ?></p> <br>
                                                                    <h6>CNPJ: </h6> <p><?php echo (!$estagio->getestagio()->getempresa()) ? NULL : $estagio->getestagio()->getempresa()->getcnpj(); ?></p> <br>
                                                                    <h6>Telefone: </h6> <p><?php echo (!$estagio->getestagio()->getempresa()) ? NULL : $estagio->getestagio()->getempresa()->gettelefone(); ?></p> <br>
                                                                    <h6>FAX: </h6> <p><?php echo (!$estagio->getestagio()->getempresa()) ? NULL : $estagio->getestagio()->getempresa()->getfax(); ?></p> <br>
                                                                    <h6>Logradouro: </h6> <p><?php echo (!$estagio->getestagio()->getempresa()) ? NULL : $estagio->getestagio()->getempresa()->getendereco()->getlogradouro(); ?></p> <br>
                                                                    <h6>Número: </h6> <p><?php echo (!$estagio->getestagio()->getempresa()) ? NULL : $estagio->getestagio()->getempresa()->getendereco()->getnumero(); ?></p> <br>
                                                                    <h6>Sala: </h6> <p><?php echo (!$estagio->getestagio()->getempresa()) ? NULL : $estagio->getestagio()->getempresa()->getendereco()->getsala(); ?></p> <br>
                                                                    <h6>Bairro: </h6> <p><?php echo (!$estagio->getestagio()->getempresa()) ? NULL : $estagio->getestagio()->getempresa()->getendereco()->getbairro(); ?></p> <br>
                                                                    <h6>Cidade: </h6> <p><?php echo (!$estagio->getestagio()->getempresa()) ? NULL : $estagio->getestagio()->getempresa()->getendereco()->getcidade(); ?></p> <br>
                                                                    <h6>UF: </h6> <p><?php echo (!$estagio->getestagio()->getempresa()) ? NULL : $estagio->getestagio()->getempresa()->getendereco()->getuf(); ?></p> <br>
                                                                    <h6>CEP: </h6> <p><?php echo (!$estagio->getestagio()->getempresa()) ? NULL : $estagio->getestagio()->getempresa()->getendereco()->getcep(); ?></p> <br>
                                                                    <h6>Cidade: </h6> <p><?php echo (!$estagio->getestagio()->getempresa()) ? NULL : $estagio->getestagio()->getempresa()->getendereco()->getcidade(); ?></p> <br>
                                                                    <h6>Nº de registro da empresa: </h6> <p><?php echo (!$estagio->getestagio()->getempresa()) ? NULL : $estagio->getestagio()->getempresa()->getnregistro(); ?></p> <br>
                                                                    <h6>Conselho de fiscalização: </h6> <p><?php echo (!$estagio->getestagio()->getempresa()) ? NULL : $estagio->getestagio()->getempresa()->getconselhofiscal(); ?></p> <br>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="modal-footer">
